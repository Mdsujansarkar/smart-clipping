                      ...
                      <div class="inputbox">
                        <div class="form-floating">
                          <select class="js-example-basic-multiple form-control" name="states[]" multiple="multiple">
                            <option value="imgClipping">Image Clipping</option>
                            <option value="photoRetouching">Photo Retouching</option>
                            <option value="imgMirroring">Mirroring & Shadows</option>
                            <option value="imgCropping">Image Sizing & Cropping</option>
                            <option value="colorCorrection">Color Corrections</option>
                            <option value="amazonEbay">Amazon & eBay Ready</option>
                          </select>
