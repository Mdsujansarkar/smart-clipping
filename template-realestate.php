            ...
            <div class="row">
                <div class="col-lg-5">
                    <figure class="qualitybox">
                        <?php if(!$sclipping['real-qualitybox']): ?>
                        ...
                        <?php else: ?>
                            <img src="<?php echo $sclipping['real-qualitybox']; ?>" alt="service-quality-thumbnail">
                        <?php endif;?>
                    </figu>
                </div>
                ...
                <div class="col-lg-7">
                    <div class="qualitydetails">
                        <h2 class="title"><?php echo $sclipping['real-qualitybox-title']; ?></h2>
                        <p class="text">
                        <?php echo $sclipping['real-qualitybox-desc']; ?>
                        </p>
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6">
                        <div class="card-product" style="box-shadow: 0 1px 13px -5px !important; border-radius: 8px;">
                            ...
                            <?php if(!$sclipping['real-beforeAfter-one'] && !$sclipping['real-beforeAfter-one']): ?>
                            ...
                            <?php else:  ?>
                                <div class="beforeAfter">
                                    <img class="after_image" src="<?php echo $sclipping['real-beforeAfter-one']; ?>" alt="after" />
                                    <img class="before_image" src="<?php echo $sclipping['real-afterAfter-one']; ?>" alt="before" />
                                </div>
                            <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-product" style="box-shadow: 0 1px 13px -5px !important; border-radius: 8px;">
                            <div class="card-product-header">
                            <?php if(!$sclipping['real-beforeAfter-two'] && !$sclipping['real-afterAfter-two']): ?>
                                <div class="beforeAfter">
                            ...
                            <?php else:  ?>
                                <div class="beforeAfter">
                                    <img class="after_image" src="<?php echo $sclipping['real-beforeAfter-two']; ?>" alt="after" />
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-product" style="box-shadow: 0 1px 13px -5px !important; border-radius: 8px;">
                            <div class="card-product-header">
                            <?php if(!$sclipping['real-beforeAfter-three'] && !$sclipping['real-afterAfter-three']): ?>
                                <div class="beforeAfter">
                                ...
                                <?php else: ?>
                                    <div class="beforeAfter">
                                    <img class="after_image" src="<?php echo $sclipping['real-beforeAfter-three']; ?>" alt="after" />
                                    <img class="before_image" src="<?php echo $sclipping['real-afterAfter-three']; ?>" alt="before" />
                                </div>
                                    <?php endif;?>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-product" style="box-shadow: 0 1px 13px -5px !important; border-radius: 8px;">
                            <div class="card-product-header">
                            <?php if(!$sclipping['real-beforeAfter-four'] && !$sclipping['real-afterAfter-four']): ?>
                                <div class="beforeAfter">
                                ...
                                <?php else: ?>
                                    <div class="beforeAfter">
                                    <img class="after_image" src="<?php echo $sclipping['real-beforeAfter-four']; ?>" alt="after" />
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-product" style="box-shadow: 0 1px 13px -5px !important; border-radius: 8px;">
                            <div class="card-product-header">
                            <?php if(!$sclipping['real-beforeAfter-five'] && !$sclipping['real-afterAfter-five']): ?>
                                <div class="beforeAfter">
                                ...
                                <?php else: ?>
                                    <div class="beforeAfter">
                                    <img class="after_image" src="<?php echo $sclipping['real-beforeAfter-five']; ?>" alt="after" />
                                    <img class="before_image" src="<?php echo $sclipping['real-afterAfter-five']; ?>" alt="before" />
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card-product" style="box-shadow: 0 1px 13px -5px !important; border-radius: 8px;">
                            <div class="card-product-header">
                            <?php if(!$sclipping['real-beforeAfter-six'] && !$sclipping['real-afterAfter-six']): ?>
                                <div class="beforeAfter">
                            ...
                            <?php else: ?>
                                <div class="beforeAfter">
                                    <img class="after_image" src="<?php echo $sclipping['real-beforeAfter-six']; ?>" alt="after" />
